      ...
      <div className='  space-y-10  max-w-lg  lg:max-w-2xl '>
        ...
        <p className="leading-7 max-w-xs  text-grey-400 [&:not(:first-child)]:mt-6">
          Anyone can beat you but no one can beat your outfit as long as you wear Dine outfits.
            ...
            <Button className=' my-10 text-md h-16 lg:w-72 rounded bg-gray-900 hover:bg-slate-500 font-semibold text-[#fff]'><FaShoppingCart className="mr-2 h-6  w-8" /> Start  Shopping </Button>
